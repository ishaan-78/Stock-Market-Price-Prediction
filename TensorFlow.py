...
future_days = 60  # Predict 30 days ahead
last_sequence = scaled_data[-60:]
future_predictions = []

for _ in range(future_days):
    X_input = np.reshape(last_sequence, (1, last_sequence.shape[0], 1))
...
plt.legend(['Historical','Future Predictions','model predict'])
plt.show()
